...
const obtenerTratamiento = async (req, res = response) => {
    const { id } = req.params;
    ...
    try {
      ...
      res.status(500).json({
        ...
        msg: "Error al obtener el tratamiento",
            ...
            module.exports = { obtenerTratamiento, crearTratamiento, borrarTratamiento, editarTratamiento, listarTratamientosSinPiezaNumero }